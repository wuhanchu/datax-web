(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-3a8a15ea"], {
    "3a8d": function (e, t, r) {
        "use strict";
        r.d(t, "c", (function () {
            return a
        ...
        function a(e) {
            return Object(o["a"])({url: "api/jobTemplate/pageList", method: "get", params: e})
        }

        function l() {
            return Object(o["a"])({url: "api/jobGroup/list", method: "get"})
        }

        function i(e) {
            return Object(o["a"])({url: "/api/jobTemplate/update", method: "post", data: e})
        }

        function n(e) {
            return Object(o["a"])({url: "/api/jobTemplate/add/", method: "post", data: e})
        }

        function s(e) {
            return Object(o["a"])({url: "/api/jobTemplate/remove/" + e, method: "post"})
        }

        function c(e) {
            return Object(o["a"])({url: "/api/jobTemplate/nextTriggerTime?cron=" + e, method: "get"})
        }
    }, a897: function (e, t, r) {
    }, c3e2: function (e, t, r) {
        "use strict";
        var o = r("a897"), a = r.n(o);
        a.a
    }, e7ae: function (e, t, r) {
        "use strict";
        r.r(t);
        var o = function () {
                ...
                return r("div", {staticClass: "app-container"}, [r("div", {staticClass: "filter-container"}, [r("el-input", {
                    staticClass: "filter-item",
                    staticStyle: {width: "200px"},
                    attrs: {placeholder: "任务描述"},
                    model: {
                    ...
                    return r("el-option", {key: e.id, attrs: {label: e.name, value: e.id}})
                })), 1), e._v(" "), r("el-button", {
                    ...
                    scopedSlots: e._u([{
                        key: "default", fn: function (t) {
                            return [r("span", [e._v(e._s(t.row.jobCron))])]
                        }
                    }])
                }), e._v(" "), r("el-table-column", {
                    ...
                    attrs: {label: "修改用户", align: "center", width: "80"},
                    scopedSlots: e._u([{
                        key: "default", fn: function (t) {
                    ...
                    scopedSlots: e._u([{
                        key: "default", fn: function (t) {
                            ...
                            }, [r("el-table", {attrs: {data: e.registerNode}}, [r("el-table-column", {
                                attrs: {
                                    width: "150",
                                    property: "title",
                                    label: "执行器名称"
                    ...
                    attrs: {label: "下次触发时间", align: "center"},
                    scopedSlots: e._u([{
                        key: "default", fn: function (t) {
                            return [r("el-popover", {
                            ...
                            }, [r("h5", {domProps: {innerHTML: e._s(e.triggerNextTimes)}}), e._v(" "), r("el-button", {
                                attrs: {
                                    slot: "reference",
                                    size: "small"
                                }, slot: "reference"
                    ...
                    scopedSlots: e._u([{
                        key: "default", fn: function (t) {
                            var o = t.row;
                            return [r("el-dropdown", {attrs: {trigger: "click"}}, [r("span", {staticClass: "el-dropdown-link"}, [e._v("\n            操作"), r("i", {staticClass: "el-icon-arrow-down el-icon--right"})]), e._v(" "), r("el-dropdown-menu", {
                                attrs: {slot: "dropdown"},
                                slot: "dropdown"
                            }, [r("el-dropdown-item", {
                                attrs: {divided: ""}, nativeOn: {
                                    click: function (t) {
                                        return e.handlerUpdate(o)
                                    }
                                }
                            }, [e._v("编辑")]), e._v(" "), r("el-dropdown-item", {
                                nativeOn: {
                                    click: function (t) {
                                        return e.handlerDelete(o)
                                    }
                                }
                            }, [e._v("删除")])], 1)], 1)]
                        }
                ...
                }, [r("el-row", {attrs: {gutter: 20}}, [r("el-col", {attrs: {span: 12}}, [r("el-form-item", {
                    attrs: {
                        label: "执行器",
                        prop: "jobGroup"
                    }
                    ...
                    return r("el-option", {key: e.id, attrs: {label: e.title, value: e.id}})
                })), 1)], 1)], 1), e._v(" "), r("el-col", {attrs: {span: 12}}, [r("el-form-item", {
                    attrs: {
                        label: "任务描述",
                        prop: "jobDesc"
                    }
                ...
                })], 1)], 1)], 1), e._v(" "), r("el-row", {attrs: {gutter: 20}}, [r("el-col", {attrs: {span: 12}}, [r("el-form-item", {
                    attrs: {
                        label: "路由策略",
                ...
                })), 1)], 1)], 1), e._v(" "), r("el-col", {attrs: {span: 12}}, [r("el-dialog", {
                    attrs: {
                        title: "提示",
                ...
                }, [e._v("关闭")]), e._v(" "), r("el-button", {
                    attrs: {type: "primary"}, on: {
                        click: function (t) {
                            e.showCronBox = !1
                        }
                    }
                }, [e._v("确 定")])], 1)], 1), e._v(" "), r("el-form-item", {
                    attrs: {
                        label: "Cron",
                        prop: "jobCron"
                    }
                    ...
                    slot: "append"
                })], 1)], 1)], 1)], 1), e._v(" "), r("el-row", {attrs: {gutter: 20}}, [r("el-col", {attrs: {span: 12}}, [r("el-form-item", {
                    attrs: {
                        label: "阻塞处理",
                    ...
                    return r("el-option", {key: e.value, attrs: {label: e.label, value: e.value}})
                })), 1)], 1)], 1), e._v(" "), r("el-col", {attrs: {span: 12}}, [r("el-form-item", {attrs: {label: "报警邮件"}}, [r("el-input", {
                    ...
                    return r("el-option", {key: e.value, attrs: {label: e.label, value: e.value}})
                })), 1)], 1)], 1), e._v(" "), r("el-col", {attrs: {span: 12}}, [r("el-form-item", {attrs: {label: "失败重试次数"}}, [r("el-input-number", {
                    attrs: {
                        min: 0,
                        max: 20
                    }, model: {
                    ...
                    return r("el-option", {key: e.id, attrs: {label: e.name, value: e.id}})
                })), 1)], 1)], 1), e._v(" "), r("el-col", {attrs: {span: 12}}, [r("el-form-item", {attrs: {label: "超时时间(分钟)"}}, [r("el-input-number", {
                    attrs: {
                        min: 0,
                        max: 120
                    }, model: {
                ...
                })], 1)], 1)], 1), e._v(" "), r("el-row", {attrs: {gutter: 20}}, [r("el-col", {attrs: {span: 12}}, [r("el-form-item", {attrs: {label: "子任务"}}, [r("el-select", {
                    attrs: {
                        multiple: "",
                        placeholder: "子任务",
                        "value-key": "id"
                    ...
                    return r("el-option", {key: e.id, attrs: {label: e.jobDesc, value: e}})
                })), 1)], 1)], 1), e._v(" "), r("el-col", {attrs: {span: 12}})], 1), e._v(" "), r("el-row", {attrs: {gutter: 20}}, [r("el-col", {attrs: {span: 24}}, [r("el-form-item", {attrs: {label: "JVM启动参数"}}, [r("el-input", {
            ...
            }, a = [], l = (r("28a5"), r("6b54"), r("39ed")), i = r("5ec8"), n = r("3a8d"), s = r("6724"), c = r("333d"),
            u = r("7e39"), d = r("a53d"), p = r("2b10"), m = {
                name: "JobTemplate",
                components: {Pagination: c["a"], Cron: i["a"]},
                directives: {waves: s["a"]},
                filters: {
                ...
                data: function () {
                    var e = this, t = function (e, t, r) {
                        t || r(new Error("Increment parameters is required")), r()
                    }, r = function (t, r, o) {
                        e.partitionField || o(new Error("Partition parameters is required")), o()
                    };
                    return {
                        projectIds: "",
                        list: null,
                        ...
                        rules: {
                            ...
                            partitionField: [{trigger: "blur", validator: r}],
                        ...
                        glueTypes: [{value: "BEAN", label: "DataX任务"}],
                        triggerNextTimes: "",
                        registerNode: []
                    }
                },
                ...
                methods: {
                    handleClose: function (e) {
                        ...
                        var e = this;
                        this.listLoading = !0, this.projectIds && (this.listQuery.projectIds = this.projectIds.toString()), n["c"](this.listQuery).then((function (t) {
                            var r = t.content;
                            e.total = r.recordsTotal, e.list = r.data, e.listLoading = !1
                        }))
                    }, handleCreate: function () {
                        var e = this;
                        this.resetTemp(), this.dialogStatus = "create", this.dialogFormVisible = !0, this.temp.jobGroup = this.executorList[0]["id"], this.$nextTick((function () {
                        ...
                        this.$refs["dataForm"].validate((function (t) {
                            if (t) {
                                if (e.temp.childJobId) {
                                    var r = [];
                                    for (var o in e.temp.childJobId) r.push(e.temp.childJobId[o].id);
                                    e.temp.childJobId = r.toString()
                                }
                                e.partitionField && (e.temp.partitionInfo = e.partitionField + "," + e.timeOffset + "," + e.timeFormatType), n["a"](e.temp).then((function () {
                        ...
                        var t = this;
                        this.resetTemp(), this.temp = Object.assign({}, e), this.dialogStatus = "update", this.dialogFormVisible = !0;
                        var r = [], o = [];
                        if (this.JobIdList) {
                            for (var a in this.JobIdList) this.JobIdList[a].id !== this.temp.id && o.push(this.JobIdList[a]);
                            this.JobIdList = o
                        }
                        if (this.temp.childJobId) {
                            var l = this.temp.childJobId.split(",");
                            for (var i in l) for (var n in this.jobIdList) this.jobIdList[n].id === parseInt(l[i]) && r.push(this.jobIdList[n]);
                            this.temp.childJobId = r
                        }
                        ...
                        this.$refs["dataForm"].validate((function (t) {
                            if (t) {
                                ...
                                e.partitionField && (e.temp.partitionInfo = e.partitionField + "," + e.timeOffset + "," + e.timeFormatType), n["f"](e.temp).then((function () {
                                    e.fetchData(), e.dialogFormVisible = !1, e.$notify({
                                        title: "Success",
                        ...
                        var t = this;
                        n["d"](e.jobCron).then((function (e) {
                            var r = e.content;
                            t.triggerNextTimes = r.join("<br>")
                        }))
                    }, loadById: function (e) {
                        var t = this;
                        l["e"](e.jobGroup).then((function (e) {
                            t.registerNode = [];
                            var r = e.content;
                            t.registerNode.push(r)
                        }))
                    }
                }
            }, b = m, f = (r("c3e2"), r("2877")), v = Object(f["a"])(b, o, a, !1, null, null, null);
        t["default"] = v.exports
    }
}]);